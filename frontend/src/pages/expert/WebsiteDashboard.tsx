...
const WebsiteDashboard = () => {
    ...
    const [patternDataforModal, setPatternDataforModal] = useState<PatternData>({
      patternType: "",
      expertName: "",
      patternPhase: "",
      comments : [""],
  ...
  return (
    <>
        ...
        <PatternDetailsComponent isOpen={isPatternModalOpen} onClose={closePatternModal} patternData={patternDataforModal}/>
