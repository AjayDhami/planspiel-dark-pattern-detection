...
const WebsiteDashboard = () => {
  ...
  return (
    <>
        ...
        <div className='mx-24 h-1/4 shadow-xl rounded-2xl bg-white grid md:grid-cols-3'>
          <div className=''>
            <div className='mx-8 my-4 pt-8 px-8 '>
            ...
            <div className='pt-8 col-span-1 m-8 px-2 shadow-xl border-2 rounded-lg h-80'>
          ...
          <div className='md:col-span-2 h-1/4 overflow-y-scroll px-8 py-4 border-l-2'>
