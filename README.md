...
This is a Web Engineering Research Project created by the V-Tenet team
...
You can check out the code for the project using [this link](https://github.com/AjayDhami/planspiel-dark-pattern-detection).
...
### [Backend](https://github.com/AjayDhami/planspiel-dark-pattern-detection/tree/main/backend-api)
...
### [ML Service](https://github.com/AjayDhami/planspiel-dark-pattern-detection/tree/main/ml-model-service)
...
### [Frontend](https://github.com/AjayDhami/planspiel-dark-pattern-detection/tree/main/frontend)
...
Clone the repository to your local machine
   ...
   $ cd v-tenet
   ```
You can run each module separately. For that check the instructions for [Backend](https://github.com/AjayDhami/planspiel-dark-pattern-detection/tree/main/backend-api),
[ML Service](https://github.com/AjayDhami/planspiel-dark-pattern-detection/tree/main/ml-model-service), [Frontend](https://github.com/AjayDhami/planspiel-dark-pattern-detection/tree/main/frontend).

Also, you can run the entire project using Docker. For that, you need to have [Docker](https://www.docker.com/get-started/)  and [Docker Compose](https://docs.docker.com/compose/) installed on your local machine.
